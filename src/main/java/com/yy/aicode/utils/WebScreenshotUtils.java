...
//            WebDriverManager.chromedriver().setup();
            System.setProperty("webdriver.chrome.driver", "E:\\Shi-Xi\\chromedriver-win64\\chromedriver.exe");

            // 使用阿里云镜像（注意 URL 末尾不需要带 /latest 等）
//            WebDriverManager.chromedriver()
//                    .driverRepositoryUrl(new URL("https://mirrors.aliyun.com/google-chrome/"))
//                    .setup();
            // 配置 Chrome 选项
