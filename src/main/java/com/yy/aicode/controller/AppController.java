package com.yy.aicode.controller;
...
import com.yy.aicode.common.BaseResponse;
import com.yy.aicode.common.DeleteRequest;
import com.yy.aicode.common.ResultUtils;
import com.yy.aicode.constant.AppConstant;
import com.yy.aicode.constant.UserConstant;
import com.yy.aicode.dto.app.*;
...
import com.yy.aicode.rateLimiter.annotation.RateLimit;
import com.yy.aicode.rateLimiter.enums.RateLimitType;
import com.yy.aicode.service.AppService;
import com.yy.aicode.service.ProjectDownloadService;
...
public class AppController {
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
        ...
        return contentFlux.map(chunk ->{
            ...
            String jsonDate = JSONUtil.toJsonStr(wrapper);
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.yy.aicode.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
